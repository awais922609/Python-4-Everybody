...
1516 Assistant that is quite helpful and capable of helping 296
...
4098 Interestingly, the kinds of things computers can do best
675 are often the kinds of things that we humans find boring 4248
and mind-numbing.
...
creativity, 5660 intuition, 519 and 6042 inventiveness to this
 partnership.  
...
perhaps 1134 the 4796 following 1935 figure is a more sensible version of our PDA:
 
For 3336 now, 9339 our 6795 primary motivation is not to make money or please end users, but
 instead for us to be more productive in handling the data and 
information that we will encounter in our lives.
6516 When you first start, you will be both the programmer and the end user of 2634
...
1468 speak to give instructions to computers to 
...
Input 6000 and 5648 Output 9723 Devices are simply our
...
9196 As a programmer, your job is to use and orchestrate 8175
...
5727 at least you will have the skills to look at a data/information
...
1102 to spell the words in this new language properly and know how to construct 
9858 well-formed sentences in this new language.
...
3332 problem you are trying to solve is the idea. 408

itemize

5547 Once you learn one programming language such as Python, you will 
find 6483 it 5459 much 5693 easier to learn a second programming language such
...
7165 to solve a brand-new problem.  We teach programming much like we teach 8612
writing.  We start reading and explaining programs, then we write 
1875 simple programs, and then we write increasingly complex programs over time.
At some point you get your muse and see the patterns on your own
5070 and can see more naturally how to take a problem and 
...
2661 Unlike human languages, the Python vocabulary is actually pretty small.
...
9150 sit, stay, and fetch.  When you talk to a dog and 20
...
what 5807 most 6909 dogs 6843 likely hear is,
 blah blah blah walk blah blah blah blah.
6447 That is because walk is a reserved word in dog language.  

The reserved words in the language where humans talk to 
Python 2009 include 6362 the 4655 following:
 
and       del       from      not       while    
as        elif      global    or        with     
assert    else      if        pass      yield    
break     except    import    print              
6421 class     exec      in        raise 4841
continue  finally   is        return             
def       for       lambda    try

9036 That is it, and unlike a dog, Python is already completely trained. 5974
...
7884 but for now we will focus on the Python equivalent of speak (in 6490
...
3222 instructions and screencasts of setting up and starting Python 
...
2770 Before we leave our first conversation with the Python 
...
3248 incorrect attempts.   The second error is different because 
...
5575 straightforward for humans to read and write and for computers
...
are 9722 only 7701 zeros 1128 and ones, but its syntax is even more complex
...
7474 and these translators convert the programs to machine language for actual 1486
...
a 6976 file 9101 as 2138 executable.
 
7208 If you were to open an executable file in a text editor, it would look 
...
with 6791 Python's 6370 features, 7969 but it is not recommended for solving more complex problems.
...
4733 the file hello.py instead of prompting us for lines of Python code 6914
interactively.
...
strings= re.findall('[0-9]+',x)

sum_of_integers= sum(int(x) for x in strings)
